...
- `2021-07-01` 🔥 **决赛开启，最终测试集发布！**
  ...
  >   > {
  >   >   team: "队名",
  >   >   task1: "011010100101101010...",
  >   >   task2: "011010100101101010...",
  >   >   task3: "011010100101101010...（每两位表示1题）"
  >   > }
  >   > ```
  >
  ...
  >   - 没有提交报告的队伍不会发放奖金和证书。
  > - 提交方式：
  >   - 发送邮件至邮箱：[sc_eval@163.com](mailto:sc_eval@163.com) 。
  >   - 邮件标题：`SpaCE2021-[<结果+代码(+模型)/报告>]-<队伍名>`，例如：`SpaCE2021-[结果+代码]-未名队`
  >   - 附件：请用 zip 格式打包全部相关材料。文件名应与邮件标题同名。
  > - 我们将在 **7月23日** 公布**比赛结果**。
  
- `2021-06-24` 校外临时报名通道开放
  
  > 各位计划参加本竞赛的朋友：大家好。
  >
  > 近期竞赛官网挂载的北大校园网可能无法从校外访问，约持续至7月10日。为此，我们建立了临时报名通道。
  >
  > 校外临时报名通道：https://2030nlp.github.io/SpaCE2021/registration.html
  >
  > 校园网正式报名通道：http://ccl.pku.edu.cn:8084/SpaCE2021/
  >
  > 报名之后，请扫二维码加群。祝您参赛愉快！
...
- `2021-06-24` 决赛微信群开启
  ...
  > 各位参赛者：大家好。
  >
  > 本竞赛将于7月1日进入决赛阶段，为了更加方便地与大家沟通，我们建立了决赛微信群，群二维码已经发至大家的报名邮箱。若未收到邮件或加群遇到问题，请联系我们。祝大家参赛愉快！
  >
  > 联系方式：sc_eval@163.com （孙春晖）
...
- `2021-06-01` 验证集答案发布！ [🔗 点击下载 dev-with-answer](http://ccl.pku.edu.cn:8084/SpaCE2021/download)
  ...
  > 无法访问网站的队伍请在加群之后联系工作人员获取。

- `2021-05-18` 数据集修订
  > 各位参赛者：大家好！
  >
  > 为了使本次竞赛数据集具有更好的理论效度，我们对已发布数据集中存在的一些小问题进行了修订，主要包括一些 context 中多余的句末标点、少量 context 及 reason 中的错别字，以及少量 context 中出现的字符错位情况。这些修订并不影响题目数量和答案正确性。数据的具体变化请看 [此处](https://github.com/2030NLP/SpaCE2021/commit/c286efc84119f307065de740bf203b1eadc53942) 。
  >
